// Main Application Module for Nutrime
let currentSection = 'food-tracker';

// Application initialization
document.addEventListener('DOMContentLoaded', () => {
    console.log('🚀 Nutrime Web App Starting...');
...
function initializeApp() {
    console.log('📱 Initializing Nutrime app...');
    ...
    console.log('✅ Nutrime app initialized successfully');
}
...
function exportData() {
    try {
        ...
        link.href = url;
        link.download = `nutrime-data-${new Date().toISOString().split('T')[0]}.json`;
        link.click();
