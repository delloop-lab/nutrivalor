...
Generated by Nutrime - Your Personal Food Tracking Companion
    `;
    ...
    link.href = url;
    link.download = `nutrime-report-${new Date().toISOString().split('T')[0]}.txt`;
    link.click();
